...
**Vet Clinic** is a realtional database that stores information about a vet clinic.
...
- you can clone this repo by typing `git clone https://github.com/enoqueJonas/clinic-vet.git`.
- type `cd clinic-vet` to access the project on terminal.
